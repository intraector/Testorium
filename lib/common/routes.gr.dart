...
class AppRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    PersonsListRoute.name: (routeData) {
      final args = routeData.argsAs<PersonsListRouteArgs>(
          orElse: () => const PersonsListRouteArgs());
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i3.PersonsList(key: args.key));
    },
    PersonDetailsRoute.name: (routeData) {
      final args = routeData.argsAs<PersonDetailsRouteArgs>();
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i4.PersonDetails(args.user));
    }
  };
...
class PersonsListRoute extends _i1.PageRouteInfo<PersonsListRouteArgs> {
  PersonsListRoute({_i5.Key? key})
      : super(name, path: '/', args: PersonsListRouteArgs(key: key));
...
class PersonDetailsRoute extends _i1.PageRouteInfo<PersonDetailsRouteArgs> {
  PersonDetailsRoute({required _i6.Person user})
      : super(name,
            path: '/person-details', args: PersonDetailsRouteArgs(user: user));
