...
abstract class $StatePersonsRepositoryCopyWith<$Res> {
  factory $StatePersonsRepositoryCopyWith(
          StatePersonsDetailsRepository value, $Res Function(StatePersonsDetailsRepository) then) =
...
class _$StatePersonsRepositoryCopyWithImpl<$Res> implements $StatePersonsRepositoryCopyWith<$Res> {
  ...
  final StatePersonsDetailsRepository _value;
  // ignore: unused_field
  final $Res Function(StatePersonsDetailsRepository) _then;
}
...
abstract class _Initial implements StatePersonsDetailsRepository {
...
abstract class _LoadInProgress implements StatePersonsDetailsRepository {
...
abstract class _Data implements StatePersonsDetailsRepository {
...
abstract class _Error implements StatePersonsDetailsRepository {
