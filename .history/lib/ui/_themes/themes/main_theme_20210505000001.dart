...
class MainTheme implements AppTheme {
  ...
  static final _primaryColor = const Color(0xff3C3E44);
  // static final _accentColor = Colors.white;
  static final _backgroundColor = const Color(0xff24282F);
  // static final Color _accentColor = Colors.blue.shade600;
  @override
  ThemeData? material = _defaultTheme.copyWith(
  ...
  @override
  CupertinoThemeData? cupertino = const CupertinoThemeData();
