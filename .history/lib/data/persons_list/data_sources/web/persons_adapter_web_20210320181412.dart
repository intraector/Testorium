...
@freezed
abstract class StateConcernsDataSource with _$StateConcernsDataSource {
  const factory StateConcernsDataSource.loadInProgress(double progress) = _LoadInProgress;
  const factory StateConcernsDataSource.data({
    List<Concern> list,
    ConcernsSummary summary,
  }) = _Data;
  const factory StateConcernsDataSource.error({
    int statusCode,
    @Default('') String msg,
