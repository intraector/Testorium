...
class PersonsCommandGetPersonDetails extends Cubit<StateCommandGetPersons> {
  PersonsCommandGetPersonDetails({int id})
      : super(const StateCommandGetPersons.loadInProgress(0.0)) {
    _run(id: id);
  }
