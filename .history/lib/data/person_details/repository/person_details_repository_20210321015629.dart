...
class PersonDetailsRepository extends Bloc<EventPersonsRepository, StatePersonsRepository> {
  PersonDetailsRepository(this._dataSources) : super(const StatePersonsRepository.initial());
