...
class CommandGetPersons extends Cubit<StateCommandGetPersons> {
  CommandGetPersons() : super(const StateCommandGetPersons.loadInProgress(0.0)) {
    _run();
  }
...
@freezed
abstract class StateCommandGetPersons with _$StateCommandGetPersonDetails {
